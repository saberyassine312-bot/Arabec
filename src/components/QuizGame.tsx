...
const questions: Question[] = [
  {
    ...
    correctAnswer: 0,
    explanation: "الجملة الاسمية هي التي تبدأ باسم (المبتدأ) مثل: 'العلمُ نورٌ'."
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation: "الجملة الفعلية هي التي تبدأ بفعل مثل: 'جاءَ الحقُ'."
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation: "شبه الجملة ليس جملة تامة المفردات، بل هو إما جار ومجرور أو ظرف."
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation: "المبتدأ والخبر هما الركيزتان اللتان تبنى عليهما الجملة الاسمية."
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation: "اسمية لأنها بدأت باسم وهو 'الشمس'."
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation: "فعلية لأنها بدأت بفعل ماضٍ وهو 'كتب'."
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation: "شبه جملة لأنها بدأت بظرف مكان وهو 'تحت'."
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation: "شبه جملة لأنها مكونة من حرف جر واسم مجرور."
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation: "فعلية لأنها بدأت بفعل وهو 'سافر'."
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation: "اسمية بدأت بالمبتدأ 'الصدق'."
  }
];
                ...
                {selectedOption !== null && (
                  ...
                  >
                    <div className={`text-xl font-bold p-4 rounded-2xl w-full text-center ${isCorrect ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-600'}`}>
                      <div className="mb-2">{isCorrect ? 'إجابة صحيحة ✅' : 'إجابة خاطئة ❌'}</div>
                      <div className="text-sm font-bold opacity-80">{questions[currentQuestion].explanation}</div>
                    </div>
                    <button
                      onClick={nextQuestion}
                      className="flex items-center gap-2 bg-emerald-600 text-white px-10 py-4 rounded-2xl font-bold hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-100 group"
                    >
