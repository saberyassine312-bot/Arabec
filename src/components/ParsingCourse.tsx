...
const LEVELS: Level[] = [
  {
    ...
    story: "في قديم الزمان، كانت هناك مملكة تسمى 'MadrasaNet'. في هذه المملكة، كان هناك نوعان من السكان: 'المتغيرون' الذين يغيرون ملابسهم (حركاتهم) حسب المكان الذي يذهبون إليه، و'الثابتون' الذين يرتدون ملابس واحدة لا تتغير أبداً مهما كان المكان. مهمتك هي التمييز بينهم لتفتح بوابة المملكة!",
